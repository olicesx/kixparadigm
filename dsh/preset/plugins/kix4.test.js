...
// ── composition parity ────────────────────────────────────
{
  ...
  ok('kixparadigm = v2 rows + exactly 3 new plugin rows', idsA.length === idsV2.length + 3)
  ok('new rows are probe/settle/mem', /- id: kix-probe/.test(a) && /- id: kix-settle/.test(a) && /- id: kix-mem/.test(a))
